...
export function export_json_to_excel(obj) {
  ...
  // });
  // var ref = 'A1:AC2';
  // wb.Sheets[SheetName[0]]["A1"].s = styleCenter
  // Object.assign({}, wb.Sheets[SheetName[0]], {
  //   '!cols': [
  //     { wch: 5 }, // 第一列
  //     { wch: 20 }, // 第二列
  //     { wch: 80 }  // 第三列
  ...
  wb.Sheets[SheetName[0]]['!merges'] = [
    // 设置A1-C1的单元格合并
      {s: {r: 0, c: 0}, e: {r: 0, c: 2}}
  ];
  wb.Sheets[SheetName[1]]['A1'].v = '列表';
  wb.Sheets[SheetName[1]]['A1'].s = {
    font: {
      name: '宋体',
      sz: 18,
      color: {rgb: "#FFFF0000"},
